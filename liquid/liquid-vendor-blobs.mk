...
PRODUCT_COPY_FILES += \
    vendor/acer/liquid/proprietary/lib/libomx_wmadec_sharedlibrary.so:system/lib/libomx_wmadec_sharedlibrary.so \
    vendor/acer/liquid/proprietary/lib/libomx_wmvdec_sharedlibrary.so:system/lib/libomx_wmvdec_sharedlibrary.so \
    vendor/acer/liquid/proprietary/lib/libpvasfcommon.so:system/lib/libpvasfcommon.so \
    vendor/acer/liquid/proprietary/lib/libpvasflocalpbreg.so:system/lib/libpvasflocalpbreg.so \
    vendor/acer/liquid/proprietary/lib/libpvasflocalpb.so:system/lib/libpvasflocalpb.so \
    vendor/acer/liquid/proprietary/etc/pvasflocal.cfg:system/etc/pvasflocal.cfg
endif
